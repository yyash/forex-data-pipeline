...
def _get_message() -> str:
    return "Hi! From the Forex Data Pipeline"
...
with DAG("forex_data_pipeline", start_date=datetime(2021, 1 ,1), 
    ...
    saving_rates = BashOperator(
        ...
        bash_command = """
            hdfs dfs -mkdir -p /user/root/forex && \
            hdfs dfs -put -f $AIRFLOW_HOME/dags/files/forex_rates.json /user/root/forex
            """
    )
    ...
    send_email_notification = EmailOperator(
        ...
        to = "ashwin.bharathwaj.sekar.2022@anderson.ucla.edu",
        subject = "Airflow - Forex Data Pipeline",
        html_content = "<h3> Forex Data Pipeline Dag Completed! </h3>"
    )
    ...
    is_forex_rates_available >> is_forex_currencies_file_available >> download_forex_rates >> saving_rates 
